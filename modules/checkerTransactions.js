...
async function check() {
  try {
    ...
    if (txChat.success) {
      ...
      log.warn(`Failed to chat Txs in check() of ${helpers.getModuleName()} module. ${txChat.errorMessage}.`);
    }
    ...
    if (txTrx.success) {
      ...
      log.warn(`Failed to chat Txs in check() of ${helpers.getModuleName()} module. ${txTrx.errorMessage}.`);
    }
